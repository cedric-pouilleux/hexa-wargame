...
import { handleClick, handleMouseDown, handleMouseMove, handleMouseUp } from './src/events/mouseEvents.js';
...
document.addEventListener('mousedown', (event) => handleMouseDown(event, raycaster, map, camera));
document.addEventListener('mouseup', (event) => handleMouseUp(event));
document.addEventListener('mousemove', (event) => handleMouseMove(event, raycaster, map, camera, renderer, cursor, mapConfig.cols, mapConfig.rows));
document.addEventListener('click', (event) => handleClick(event, raycaster, map, mapConfig));
